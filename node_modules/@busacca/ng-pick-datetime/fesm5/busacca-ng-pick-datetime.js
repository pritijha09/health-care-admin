...
import { InjectionToken, inject, LOCALE_ID, Optional, Inject, Injectable, NgModule, ChangeDetectorRef, Input, HostBinding, HostListener, Directive, ɵɵdefineInjectable, EventEmitter, ElementRef, NgZone, Output, Component, ChangeDetectionStrategy, ViewChild, TemplateRef, Injector, SkipSelf, ViewContainerRef, forwardRef, Renderer2, Pipe } from '@angular/core';
import { __extends, __spread, __decorate, __param, __values, __assign } from 'tslib';
...
var OWL_DATE_TIME_LOCALE_PROVIDER = { provide: OWL_DATE_TIME_LOCALE, useExisting: LOCALE_ID };
